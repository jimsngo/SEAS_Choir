...
const PDFS_DIR = path.resolve(__dirname, '../../src/data/pdfs');
const OUTPUT_FILE = path.resolve(__dirname, '../../output/music.pdf');
const MOMENTS_PATH = path.join(__dirname, '../../config/moments.json');
const MASS_INFO_PATH = path.resolve(__dirname, '../../config/mass_info.json');
const os = require('os');
